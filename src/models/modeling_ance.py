...
class ANCE(RobertaForSequenceClassification):
    ...
    def query_emb(self, input_ids=None, inputs_embeds=None, attention_mask=None):
    ...
    def doc_emb(self, input_ids=None, inputs_embeds=None, attention_mask=None):
        return self.query_emb(input_ids, inputs_embeds, attention_mask)
