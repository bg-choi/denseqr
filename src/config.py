...
class Arguments(TrainingArguments):
    ...
    src_path: str = field(
        default='finetuning', metadata={"help": "Path to source code"}
    )
    data_dir: str = field(
    ...
    encode_shard_size: int = field(default=int(1 * 10**6))
    ...
    search_file: str = field(default='test_raw_queries', metadata={"help": "search file name"})
    ...
    file_name: Optional[str] = field(default='query', metadata={"help": "which query type to search"})
    # query_type: str = field(default='query', metadata={"help": "which query type to search"})
